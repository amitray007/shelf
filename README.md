...
Not yet built, intentionally: Compose-volume orchestration, R2 backup and recovery, a permanent purge policy, administrative password recovery, live R2 conformance, content-aware diff adapters, and bulk import and export. The [product contract](docs/plans/2026-08-17-0030-feat-shelf-product-plan.md#product-delivery-roadmap) holds the delivery roadmap.
