...
| T5 | Complete self-host deployment shape beyond the T5a-T5b reference and reconciliation profiles | Must still include upgrade, backup, restore, destructive cleanup policy, TLS/reverse-proxy qualification, live R2 conformance, and administrative recovery paths. |
