...
|---|---|---|
| P1 | Initial renderable and content-comparable formats | Defines the first useful rendered and content-level diff coverage beyond structural descriptor comparison. |
